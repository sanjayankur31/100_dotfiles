...
#
# File : timesheet-misc.sh
#
# This generates timesheet data for my miscellaneous tasks
#
...
project_filter="project.isnt:fedora project.isnt:research project.isnt:phd project.isnt:rpmfusion project.isnt:fudcon project.isnt:thesis"
