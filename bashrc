...
if [[ $- == *i* ]] ; then
    ...
    alias vit-tl-today="vit 'project!~research.lit' 'tags!~tickler' 'project!~agenda' 'due.before:eod'"
    alias vit-tl-week="vit 'project!~research.lit' 'tags!~tickler' 'project!~agenda' 'due.before:eoww'"
